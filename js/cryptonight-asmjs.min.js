...
var asm = (function(global, env, buffer) {
    ...
    function Wa() {
        ...
        g = c[n + 4 >> 2] | 0;
        a = c[n >> 2] | 0;
        a = j + 1901 + m + k + (b + j) + i + h + g + a + (rb() | 0) | 0;
        if (b | 0) $a(b);
        sb(a);
        c[d >> 2] = 0;
        Xa(d, 2, 0) | 0;
    ...
    function pb(a) {
        ...
        do
            if (a) {
                ...
                if (!(c[1844] | 0)) b = 0;
                else b = pb(c[1844] | 0) | 0;
                a = c[(nb() | 0) >> 2] | 0;
                if (a)
                    do {
                        if ((c[a + 76 >> 2] | 0) > -1) d = lb(a) | 0;
                        else d = 0;
                        if ((c[a + 20 >> 2] | 0) >>> 0 > (c[a + 28 >> 2] | 0) >>> 0) b = qb(a) | 0 | b;
                        if (d | 0) mb(a);
                        a = c[a + 56 >> 2] | 0
                    } while ((a | 0) != 0);
                ob()
